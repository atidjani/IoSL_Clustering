...
plt.errorbar(sizes, [i[0] for i in ten], yerr=[i[1] for i in ten], fmt='gs', label="10")
plt.errorbar(sizes, [i[0] for i in fifteen], yerr=[i[1] for i in fifteen], fmt='bo', label="15")
