...
gradient <- function(x, eps, minPts = 5, eps_cl, xi, search = "kdtree",
...
plot.gradient <- function(x, y=NULL, cluster = TRUE, ...) {
...
predict.gradient <- function (object, data, newdata = NULL, ...) {
